...
{ stdenv, fetchFromGitHub, autoconf, automake, cmake, curl, emscripten, freeglut
, gcc, git, jdk11, libtool, libuuid, mesa_glu, openalSoft, python27Packages, rpm
, valgrind, waf, xorgproto, xvfb_run, libXi, libXext, }:
...
in stdenv.mkDerivation rec {
  ...
  meta = with stdenv.lib; {
    broken = true;
    description =
      "A free and open-source game engine for cross-platform development.";
